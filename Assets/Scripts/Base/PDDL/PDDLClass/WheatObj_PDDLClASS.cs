...
using System.Text;
using UnityEngine;
public class WheatObj_PDDL:PDDLClass<WheatObj,WheatType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public WheatObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("WheatObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
            () => { return (TableModel_PDDL)(obj.belong.GetPDDLClass()); },
            () => { return obj.belong; });
            
}
public override void SetObj(object obj){
            this.obj=(WheatObj)obj;
            ((WheatObj)obj).pddl = this;
belong.SetObj(((WheatObj)obj).belong);
  ((WheatObj)obj).belong.pddl = belong;  
}
