...
using System.Text;
using UnityEngine;
public class PlaceObj_PDDL:PDDLClass<PlaceObj,PlaceType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public PlaceObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("PlaceObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
            () => { return (TableModel_PDDL)(obj.belong.GetPDDLClass()); },
            () => { return obj.belong; });
            
}
public override void SetObj(object obj){
            this.obj=(PlaceObj)obj;
            ((PlaceObj)obj).pddl = this;
belong.SetObj(((PlaceObj)obj).belong);
  ((PlaceObj)obj).belong.pddl = belong;  
}
