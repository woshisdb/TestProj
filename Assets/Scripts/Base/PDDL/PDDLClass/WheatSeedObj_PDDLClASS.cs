...
using System.Text;
using UnityEngine;
public class WheatSeedObj_PDDL:PDDLClass<WheatSeedObj,WheatSeedType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public WheatSeedObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("WheatSeedObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
            () => { return (TableModel_PDDL)(obj.belong.GetPDDLClass()); },
            () => { return obj.belong; });
            
}
public override void SetObj(object obj){
            this.obj=(WheatSeedObj)obj;
            ((WheatSeedObj)obj).pddl = this;
belong.SetObj(((WheatSeedObj)obj).belong);
  ((WheatSeedObj)obj).belong.pddl = belong;  
}
