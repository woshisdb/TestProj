...
using System.Text;
using UnityEngine;
public class FarmObj_PDDL:PDDLClass<FarmObj,FarmType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public FarmObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("FarmObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
            () => { return (TableModel_PDDL)(obj.belong.GetPDDLClass()); },
            () => { return obj.belong; });
            
}
public override void SetObj(object obj){
            this.obj=(FarmObj)obj;
            ((FarmObj)obj).pddl = this;
belong.SetObj(((FarmObj)obj).belong);
  ((FarmObj)obj).belong.pddl = belong;  
}
