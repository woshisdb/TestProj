...
using System.Text;
using UnityEngine;
public class BuildingResObj_PDDL:PDDLClass<BuildingResObj,BuildingResType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public BuildingResObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("BuildingResObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
            () => { return (TableModel_PDDL)(obj.belong.GetPDDLClass()); },
            () => { return obj.belong; });
            
}
public override void SetObj(object obj){
            this.obj=(BuildingResObj)obj;
            ((BuildingResObj)obj).pddl = this;
belong.SetObj(((BuildingResObj)obj).belong);
  ((BuildingResObj)obj).belong.pddl = belong;  
}
