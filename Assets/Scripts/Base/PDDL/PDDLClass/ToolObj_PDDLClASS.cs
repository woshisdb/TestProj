...
using System.Text;
using UnityEngine;
public class ToolObj_PDDL:PDDLClass<ToolObj,ToolType>{
...
public ToolObj_PDDL():base(){
            ...
            () => { return new Predicate("ToolObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
...
public override void SetObj(object obj){
            ...
            ((ToolObj)obj).pddl = this;
belong.SetObj(((ToolObj)obj).belong);
  ((ToolObj)obj).belong.pddl = belong;  
}
