...
using System.Text;
using UnityEngine;
public class GongchangObj_PDDL:PDDLClass<GongchangObj,GongchangType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public GongchangObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("GongchangObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
            () => { return (TableModel_PDDL)(obj.belong.GetPDDLClass()); },
            () => { return obj.belong; });
            
}
public override void SetObj(object obj){
            this.obj=(GongchangObj)obj;
            ((GongchangObj)obj).pddl = this;
belong.SetObj(((GongchangObj)obj).belong);
  ((GongchangObj)obj).belong.pddl = belong;  
}
