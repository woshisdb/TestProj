...
using System.Text;
using UnityEngine;
public class BuildingObj_PDDL:PDDLClass<BuildingObj,BuildingType>{
...
public BuildingObj_PDDL():base(){
            ...
            () => { return new Predicate("BuildingObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
...
public override void SetObj(object obj){
            ...
            ((BuildingObj)obj).pddl = this;
belong.SetObj(((BuildingObj)obj).belong);
  ((BuildingObj)obj).belong.pddl = belong;  
}
