...
using System.Text;
using UnityEngine;
public class WheatTreeObj_PDDL:PDDLClass<WheatTreeObj,WheatTreeType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public WheatTreeObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("WheatTreeObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
            () => { return (TableModel_PDDL)(obj.belong.GetPDDLClass()); },
            () => { return obj.belong; });
            
}
public override void SetObj(object obj){
            this.obj=(WheatTreeObj)obj;
            ((WheatTreeObj)obj).pddl = this;
belong.SetObj(((WheatTreeObj)obj).belong);
  ((WheatTreeObj)obj).belong.pddl = belong;  
}
