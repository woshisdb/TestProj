...
using System.Text;
using UnityEngine;
public class GoldKuangObj_PDDL:PDDLClass<GoldKuangObj,GoldKuangType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public GoldKuangObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("GoldKuangObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
            () => { return (TableModel_PDDL)(obj.belong.GetPDDLClass()); },
            () => { return obj.belong; });
            
}
public override void SetObj(object obj){
            this.obj=(GoldKuangObj)obj;
            ((GoldKuangObj)obj).pddl = this;
belong.SetObj(((GoldKuangObj)obj).belong);
  ((GoldKuangObj)obj).belong.pddl = belong;  
}
