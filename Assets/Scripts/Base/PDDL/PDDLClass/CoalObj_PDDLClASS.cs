...
using System.Text;
using UnityEngine;
public class CoalObj_PDDL:PDDLClass<CoalObj,CoalType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public CoalObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("CoalObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
            () => { return (TableModel_PDDL)(obj.belong.GetPDDLClass()); },
            () => { return obj.belong; });
            
}
public override void SetObj(object obj){
            this.obj=(CoalObj)obj;
            ((CoalObj)obj).pddl = this;
belong.SetObj(((CoalObj)obj).belong);
  ((CoalObj)obj).belong.pddl = belong;  
}
