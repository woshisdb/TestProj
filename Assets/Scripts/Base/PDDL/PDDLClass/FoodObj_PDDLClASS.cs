...
using System.Text;
using UnityEngine;
public class FoodObj_PDDL:PDDLClass<FoodObj,FoodType>{
...
public FoodObj_PDDL():base(){
            ...
            () => { return new Predicate("FoodObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
...
public override void SetObj(object obj){
            ...
            ((FoodObj)obj).pddl = this;
belong.SetObj(((FoodObj)obj).belong);
  ((FoodObj)obj).belong.pddl = belong;  
}
