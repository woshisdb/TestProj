...
using System.Text;
using UnityEngine;
public class RawObj_PDDL:PDDLClass<RawObj,RawType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public RawObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("RawObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
...
public override void SetObj(object obj){
            this.obj=(RawObj)obj;
            ((RawObj)obj).pddl = this;
belong.SetObj(((RawObj)obj).belong);
  ((RawObj)obj).belong.pddl = belong;  
}
