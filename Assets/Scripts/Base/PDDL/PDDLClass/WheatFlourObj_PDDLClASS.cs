...
using System.Text;
using UnityEngine;
public class WheatFlourObj_PDDL:PDDLClass<WheatFlourObj,WheatFlourType>{
public PDDLValRef<TableModel_PDDL,TableModel> belong;
public WheatFlourObj_PDDL():base(){
            

            belong = new PDDLValRef<TableModel_PDDL,TableModel>(
            () => { return new Predicate("WheatFlourObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
            () => { return (TableModel_PDDL)(obj.belong.GetPDDLClass()); },
            () => { return obj.belong; });
            
}
public override void SetObj(object obj){
            this.obj=(WheatFlourObj)obj;
            ((WheatFlourObj)obj).pddl = this;
belong.SetObj(((WheatFlourObj)obj).belong);
  ((WheatFlourObj)obj).belong.pddl = belong;  
}
