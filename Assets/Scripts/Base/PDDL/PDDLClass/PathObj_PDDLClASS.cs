...
using System.Text;
using UnityEngine;
public class PathObj_PDDL:PDDLClass<PathObj,PathType>{
...
public PathObj_PDDL():base(){
            ...
            () => { return new Predicate("PathObj_belong",obj.GetPtype(),obj.belong.GetPtype()); },
...
public override void SetObj(object obj){
            ...
            ((PathObj)obj).pddl = this;
belong.SetObj(((PathObj)obj).belong);
  ((PathObj)obj).belong.pddl = belong;  
}
